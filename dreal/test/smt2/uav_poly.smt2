...
; Add (assert (and (= bc_2 100.0) (= qc_2 12.13425994873047))) here
(assert (and (= bc_2 100.0) (= qc_2 12.13425994873047)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_1 100.0) (= qc_1 12.12425994873047))) here
(assert (and (= bc_1 100.0) (= qc_1 12.12425994873047)))
