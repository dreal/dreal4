...
; Add (assert (and (= bc_3 50.0) (= qc_3 48.013125))) here
(assert (and (= bc_3 50.0) (= qc_3 48.013125)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_2 50.0) (= qc_2 48.45048336105687))) here
(assert (and (= bc_2 50.0) (= qc_2 48.45048336105687)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_1 50.0) (= qc_1 48.0625))) here
(assert (and (= bc_1 50.0) (= qc_1 48.0625)))
