...
;charging
(assert(= x0_7 0))
(assert(= b0_7 (+ bi_7 (* battery_charging_rate t0_7 t0_7))))
...
(assert(= b1_7 (- b0_7 (* battery_discharge_rate_fly t1_7 t1_7))))
...
; Add (assert (and (= bc_7 50.01149560164396) (= qc_7 48.01014512307378))) here
(assert (and (= bc_7 50.01149560164396) (= qc_7 48.01014512307378)))
...
;charging
(assert(= x0_6 0))
(assert(= b0_6 (+ bi_6 (* battery_charging_rate t0_6 t0_6))))
...
(assert(= b1_6 (- b0_6 (* battery_discharge_rate_fly t1_6 t1_6))))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_6 50.01066873530602) (= qc_6 47.00650015877275))) here
(assert (and (= bc_6 50.01066873530602) (= qc_6 47.00650015877275)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_5 50.00073899596129) (= qc_5 48.02251789057488))) here
(assert (and (= bc_5 50.00073899596129) (= qc_5 48.02251789057488)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_4 50.00073899596129) (= qc_4 47.01002182159917))) here
(assert (and (= bc_4 50.00073899596129) (= qc_4 47.01002182159917)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_3 50.00073899596129) (= qc_3 47.00002182159918))) here
(assert (and (= bc_3 50.00073899596129) (= qc_3 47.00002182159918)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_2 50.00073899596129) (= qc_2 47.9984006952212))) here
(assert (and (= bc_2 50.00073899596129) (= qc_2 47.9984006952212)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_1 50.0) (= qc_1 49.59308624267578))) here
(assert (and (= bc_1 50.0) (= qc_1 49.59308624267578)))
