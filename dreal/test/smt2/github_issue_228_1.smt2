...
;        , 3=square
;        , 4=irregular
(declare-fun subtype () Real)
(assert (or (= subtype 0) (= subtype 1) (= subtype 2) (= subtype 3) (= subtype 4)))
