...
std::experimental::optional<Box> CheckLyapunov(
    const std::vector<Variable>& x, const Variable& t,
    const std::vector<Expression>& f, const Expression& V, double ball_lb,
    double ball_ub, double t_lb, double t_ub, Config config);
...
std::experimental::optional<Box> SynthesizeLyapunov(
    const std::vector<Variable>& x, const Variable& t,
    const std::vector<Expression>& f, const Expression& V, double ball_lb,
    double ball_ub, double c_lb, double c_ub, double t_lb, double t_ub,
    Config config);
