...
export PYTHONPATH=/opt/dreal/4.18.10.1/lib/python2.7/site-packages:${PYTHONPATH}
```
...
```bash
export PKG_CONFIG_PATH=/opt/dreal/4.18.10.1/lib/pkgconfig:/opt/libibex/2.7.2/share/pkgconfig:${PKG_CONFIG_PATH}
```
